      ...
      <main>
        ...
        <section className="bg-[#DADAE5]">
          <div className="wrapper pt-[70px]">
            <h2
              className={`font-[700] text-[30px] leading-[34px] text-[#27307D] pb-5 md:text-[49px] tab:text-[52px] md:leading-[64px]  md:pr-[3%] tab:pr-0  2xl:pr-[19%]  ${
                isDesktops
                  ? "tab-desktop-elips elips-commmon md:before:h-[21px] md:before:bottom-[18%] md:before:left-[34%]"
                  : "elips-mobile elips-commmon before:h-[14px] small:before:bottom-[18%] small:before:left-[33%] before:left-[36%] before:bottom-[36%]"
              }`}
            >
              {!isDesktops
        ...
        <section className="py-[85px]">
          <div className="wrapper relative">
            <h2
              className={`font-[700] text-[30px] leading-[64px] text-[#27307D] text-center mb-4 elips elips-commmon md:text-[52px] md:leading-[64px] ${

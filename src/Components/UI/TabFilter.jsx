      ...
      <div className={`bg-white ${active ? "fed-in-left" : ""}`}>
        <div className={`wrapper pt-[45px] pb-[35px] `}>
          ...
          <ul className="flex flex-col md:flex-row md:justify-between  md:mr-[40%] md:w-[55%]">
            <li className="text-center bg-[#E9EAF2] mb-3 py-[34px] rounded-[16px] font-[500] text-[16px] leading-[21px] text-black tab-filter1 tab-desk-1 tab-list md:basis-[30%] md:pt-[95px] md:pb-[18px]">
            ...
            <li className="text-center bg-[#E9EAF2] mb-3 py-6 rounded-[16px] font-[500] text-[16px] leading-[21px] text-black tab-filter2 tab-desk-2 tab-list md:basis-[30%] md:pt-[95px] md:pb-[18px]">
              {!isDesktops ? "Financial Analysis" : "Financial Analysis"}
            </li>
            <li className="text-center bg-[#E9EAF2] mb-3 py-6 rounded-[16px] font-[500] text-[16px] leading-[21px] text-black tab-filter3 tab-list tab-desk-3 md:basis-[30%] md:pt-[95px] md:pb-[18px]">
